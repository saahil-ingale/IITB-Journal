...
package Gates is
  ...
  component VEC is
   port (A: in std_logic_vector; Y: out std_logic_vector);
  end component VEC;
  
  component XOR_4 is
   port (A: in std_logic_vector ; B: in std_logic_vector; Y: out std_logic_vector);
  end component XOR_4;
...
architecture Equations of DEM8 is
begin
   Y(0) <= (not A(0)) AND (NOT A(1)) AND (NOT A(2));
	Y(1) <= ( A(0)) AND (NOT A(1)) AND (NOT A(2));
	Y(2) <= (not A(0)) AND ( A(1)) AND (NOT A(2));
	Y(3) <= ( A(0)) AND ( A(1)) AND (NOT A(2));
	Y(4) <= (not A(0)) AND (NOT A(1)) AND ( A(2));
...
architecture Equations of VEC is
begin
   Y <= A;
end Equations;
